        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              _NavItem(icon: Icons.history_rounded, label: 'History', isActive: currentIndex == 3, onTap: () => onTap(3)),
              _NavItem(icon: Icons.bar_chart_rounded, label: 'Analytics', isActive: currentIndex == 4, onTap: () => onTap(4)),
            ],
          ),
        ),
      ),
